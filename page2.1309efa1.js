...
function renderProducts(products) {
    ...
    console.log('RENDER2');
    // Если перестанет работать переход data-id="${product._id}" - вернуть на <a> с классом product-link
    // // Добавляем обработчики кликов по товарам (сохранение ID в localStorage)
    // document.querySelectorAll('.product-link').forEach(link => {
    //   link.addEventListener('click', function () {
    //     console.log('get attrib', this)
    ...
    //додавання до кошику продуктів з кліком на кнопку
...
//# sourceMappingURL=page2.1309efa1.js.map
